...
3. **Anhang**: die Eingangspositionen, die Rezepturen je Produkt, die Ausbeute
   und die Portionen je Zutat, damit jede Zahl des Berichts nachvollziehbar
   bleibt.
...
!!! nachlesen "Zum Nachlesen"
    Die Abschnitte des Berichts im Einzelnen beschreibt [Bericht](../bericht.md).

Damit ist die Beispielprüfung vollständig.

[Weiter: Danach <span>Die Prüfung wiederfinden, weitergeben und die eigene beginnen</span>](danach.md){ .us-next }
