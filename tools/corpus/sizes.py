...
SIZE_MIX = {
    ...
    "nonfood":     [("Stk", 26), ("cm", 14), ("m", 12), ("l", 14), ("pack", 22),
                    ("curated", 12)],
    "gefluegel":   [("kg", 42), ("g", 18), ("Stk", 12), ("pack", 16), ("curated", 12)],
    "fisch":       [("kg", 40), ("g", 22), ("Stk", 8), ("pack", 16), ("curated", 14)],
    "obst":        [("kg", 40), ("g", 12), ("Stk", 12), ("pack", 22), ("curated", 14)],
    "feinkost":    [("g", 32), ("kg", 18), ("ml", 10), ("l", 8), ("Stk", 8),
                    ("pack", 14), ("curated", 10)],
    "tiefkuehl":   [("kg", 38), ("g", 16), ("Stk", 10), ("pack", 22), ("curated", 14)],
    "eis_dessert": [("l", 26), ("ml", 14), ("g", 16), ("Stk", 12), ("pack", 20),
                    ("curated", 12)],
    "suesswaren":  [("g", 34), ("kg", 16), ("Stk", 14), ("pack", 24), ("curated", 12)],
    "tee_gewuerze": [("g", 36), ("kg", 18), ("Stk", 8), ("pack", 24), ("curated", 14)],
    "saefte_alkoholfrei": [("l", 42), ("ml", 14), ("cl", 4), ("pack", 26), ("curated", 14)],
    "brauerei":    [("l", 44), ("ml", 8), ("%", 8), ("pack", 26), ("curated", 14)],
    "reinigung_hygiene": [("l", 24), ("ml", 10), ("Stk", 20), ("m", 10), ("kg", 10),
                          ("pack", 18), ("curated", 12)],
    "verpackung_einweg": [("Stk", 30), ("cm", 14), ("m", 12), ("ml", 10),
                          ("pack", 22), ("curated", 12)],
    "gastrobedarf_technik": [("Stk", 30), ("cm", 20), ("l", 10), ("m", 6),
                             ("pack", 20), ("curated", 14)],
    "waesche_service": [("Stk", 34), ("cm", 14), ("kg", 12), ("pack", 22),
                        ("curated", 18)],
    "blumen_deko": [("Stk", 32), ("cm", 20), ("pack", 26), ("curated", 22)],
    "bio_hof":     [("kg", 34), ("g", 14), ("l", 14), ("Stk", 10), ("pack", 16),
                    ("curated", 12)],
    "catering":    [("Stk", 28), ("kg", 16), ("l", 10), ("pack", 22), ("curated", 24)],
    "tabak":       [("Stk", 40), ("g", 18), ("pack", 26), ("curated", 16)],
