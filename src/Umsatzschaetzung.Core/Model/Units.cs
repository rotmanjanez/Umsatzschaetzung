...
public static class Units
{
    ...
    {
        ['1'] = 'l', ['i'] = 'l', ['|'] = 'l', [')'] = 'l', ['0'] = 'o', ['5'] = 's', ['8'] = 'b', ['2'] = 'z', ['6'] = 'g', ['e'] = 'f',
    };

    static string Fold(string s) =>
        string.Concat(s.ToLowerInvariant().Select(c => Confusable.GetValueOrDefault(c, c)));

    // A folded form two codes could claim is dropped, so a hit is unambiguous by construction.
    ...
    // After Resolve missed: "Fl" comes back as "F1", "EI" or "Bt)", and the quantity column
    // bleeds in as "17F1". A single character is a stray, not a litre.
