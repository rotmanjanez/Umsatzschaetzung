...
public static class Html
{
    ...
    public static string Render(Case c, RuleSet rs, Model.Report r)
    {
        ...
        b.Append("<title>").Append(Esc("Ausbeutekalkulation " + c.Label)).Append("</title>\n");
        b.Append("<style>\n").Append(Css(c, f)).Append("</style>\n</head>\n<body>\n<main>\n");

        b.Append("<header class=\"cover\">\n<div class=\"cover-left\">\n");
        b.Append("<div class=\"note\">Ausbeutekalkulation</div>\n<hr class=\"light\">\n");
        ...
        b.Append("<p><strong>Ausbeutekalkulation ").Append(Esc(c.Label)).Append(", Zeitraum ").Append(Esc(f.Period)).Append("</strong></p>\n");
    ...
    private static string Css(Case c, FullDisplay f)
    {
        ...
        var header = CssString("Ausbeutekalkulation · " + c.Label);
