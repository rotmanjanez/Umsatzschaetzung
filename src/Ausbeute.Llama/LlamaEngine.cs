...
public sealed class LlamaEngine : ILlmEngine
{
    ...
    static class Native
    {
        const string Lib = "ausbeute_llm";

        [DllImport(Lib, EntryPoint = "ausbeute_llm_open", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr Open([MarshalAs(UnmanagedType.LPUTF8Str)] string modelPath, int nCtx, int nThreads, out IntPtr err);

        [DllImport(Lib, EntryPoint = "ausbeute_llm_complete", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(Lib, EntryPoint = "ausbeute_llm_abort", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Abort(IntPtr h);

        [DllImport(Lib, EntryPoint = "ausbeute_llm_close", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Close(IntPtr h);

        [DllImport(Lib, EntryPoint = "ausbeute_llm_free", CallingConvention = CallingConvention.Cdecl)]
